...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center overflow-y-auto z-[999] px-4">
      {!isFullscreen && (
        <div
          className="fixed inset-0 h-full w-full bg-black/30 dark:bg-black/50 backdrop-blur-sm z-[998]"
          onClick={onClose}
        ></div>
      )}
      <div
